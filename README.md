...
The pairs were derived through a crawl of Biblical and Modern Hebrew dictionaries and the calculation of cosine distance based on the words' English definitions as represented by two transformer models ([**all-MiniLM-L6-v2**](https://huggingface.co/sentence-transformers/all-MiniLM-L6-v2) and [**paraphrase-multilingual-MiniLM-L12-v2**](https://huggingface.co/sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2)).
